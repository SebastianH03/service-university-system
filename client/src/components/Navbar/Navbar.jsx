  ...
  return (
    <div className="nav-container">
      ...
      <div className="nav-links">
        ...
        <a href='/reserve' className="nav-link"><i class="fa fa-ticket" aria-hidden="true"></i>Generar reserva</a>
        <a href='/' className="nav-link"><i class="fa-solid fa-user"></i>Usuarios</a>
        <a href='/' className="nav-link"><i class="fa-solid fa-newspaper"></i>Bitácora de servicios</a>
